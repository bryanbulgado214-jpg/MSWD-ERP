...
export default function ItemCatalogPage() {
  ...
  async function load() {
    try {
      ...
      setState({
        status: 'error',
        message: e instanceof InventoryApiError ? e.message : 'Failed to load items.',
      });
    }
  }
      ...
      {showForm && (
        <form className="inv-form" onSubmit={handleSubmit}>
          ...
          <div className="inv-form-actions">
            <button type="button" className="inv-btn" onClick={resetForm}>
              Cancel
            </button>
          ...
          <table className="inv-table">
            ...
            <tbody>
              {state.data.map((item) => (
                <tr key={item.id}>
                  <td>
                    <span className="inv-table__link">{item.itemCode}</span>
                  </td>
                  <td>{item.description}</td>
                  <td>
                    <span className={`inv-badge inv-badge--${item.classification}`}>
