...
export function InspectionListPage() {
  ...
  if (state.status === 'loading') return <div className="pr-page"><div className="pr-empty">Loading inspections...</div></div>;
    ...
    <div className="pr-page">
      <div className="pr-list-header">
        ...
        {hasPermission('procurement.inspection.create') && (
          <Link to="/procurement/inspections/new" className="pr-btn pr-btn--primary" style={{ textDecoration: 'none' }}>
            + New Inspection
          </Link>
        )}
      </div>
