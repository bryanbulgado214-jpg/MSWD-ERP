  ...
  if (!hasPermission('billing.reports')) {
    return (
      <div className="bill-page">
        <BillingSubNav />
        <div className="bill-error">You do not have access to billing reports.</div>
      </div>
    );
  }
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '24px', fontWeight: 700, color: '#175cd3' }}>
            {d.paymentCount}
          </div>
        </div>
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div>
            <span style={{ color: '#667085' }}>Total Billed:</span>{' '}
            <strong className="bill-text-mono">{formatPeso(d.totalBilled)}</strong>
          </div>
          <div>
            <span style={{ color: '#667085' }}>Total Paid:</span>{' '}
            <strong className="bill-text-mono" style={{ color: '#039855' }}>
              {formatPeso(d.totalPaid)}
            </strong>
          </div>
          <div>
            ...
            <strong
              ...
              style={{ color: d.balance > 0 ? '#d92d20' : '#039855' }}
            >
      ...
      {d.payments.length > 0 ? (
        ...
        <div className="bill-empty" style={{ padding: '16px 0' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '22px', fontWeight: 700, fontVariantNumeric: 'tabular-nums' }}>
            {d.totalConsumption.toLocaleString()} cu.m.
          </div>
        </div>
      </div>
